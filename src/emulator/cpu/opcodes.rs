...
impl Opcode {
    ...
    pub fn generate_normal_opcode_map() -> HashMap<u8, Opcode> {
        let opcodes: Vec<Opcode> = vec![
            ...
            Opcode::new(0x16, "LD D, n8".to_string(), 2, 2, AddressingMode::ImmediateRegister(Register::D), AddressingMode::ImmediateU8),
            ...
            Opcode::new(0x78, "LD A, B".to_string(), 1, 1, AddressingMode::ImmediateRegister(Register::A), AddressingMode::ImmediateRegister(Register::B)),
            ...
            Opcode::new(0x7d, "LD A, L".to_string(), 1, 1, AddressingMode::ImmediateRegister(Register::A), AddressingMode::ImmediateRegister(Register::L)),
            ...
            Opcode::new(0x86, "ADD A, [HL]".to_string(), 1, 2, AddressingMode::ImmediateRegister(Register::A), AddressingMode::AddressRegister(Register::HL)),
